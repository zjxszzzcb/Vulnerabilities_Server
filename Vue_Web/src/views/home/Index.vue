...
<div class="home">
  ...
  <div style="width: 12px;height:12px;background-color:#f9a332;border-radius: 50%;float: left;margin-top: 5px; margin-right: 8px;"></div>管理系统数据统计</p>
  <el-row :gutter="40" class="data_row" :model="basic">
    <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="8">
      <div style="background: linear-gradient(to right, #6D80FE, #23D2FD);">
        ...
        <div class="data_right">
          <h1>{{basic.usernum}}<span>人</span></h1>
          <p>用户人数</p>
        </div>
      </div>
    </el-col>
    <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="8">
      <div style="background: linear-gradient(to right, #FF988B, #FF6B88);">
        ...
        <div class="data_right">
          <h1>{{basic.foodnum}}<span>个</span></h1>
          <p>菜品个数</p>
        </div>
      </div>
    </el-col>
    <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="8">
      <div style="background: linear-gradient(to right, #717CFE, #FC83EC);">
        ...
        <div class="data_right">
          <h1>{{basic.ordernum}}<span>条</span></h1>
          <p>订单</p>
        </div>
      </div>
    </el-col>
  ...
  <!--显示菜品 start-->
  <p style="margin-bottom:15px;color: #144b9f;">
  <div style="width: 12px;height:12px;background-color:#f9a332;border-radius: 50%;float: left;margin-top: 5px; margin-right: 8px;"></div>菜品信息介绍</p>
