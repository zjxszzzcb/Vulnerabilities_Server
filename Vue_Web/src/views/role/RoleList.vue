  ...
  <el-card class="box-card">
    ...
    <template #header>
      <div class="card-header">
        ...
        <div class="card-search">
          <el-row :gutter="10">
            <el-col :span="10">
              <el-input :prefix-icon="Search" v-model="searchValue" @keyup.enter.native="search" placeholder="角色名搜索（回车）"/>
            </el-col>
            <el-col :span="11">
              <div class="my-button">
    ...
    <div class="table-box">
      <el-table element-loading-text="数据加载中..." v-loading="loading" :data="tableData"
        ...
        <el-table-column label="角色级别">
          <template #default="scope">
            <el-tooltip :content="scope.row.level" palacement="top" effect="light">
              <span class="highlight">{{scope.row.level}}</span>
            </el-tooltip>
          </template>
        </el-table-column>
